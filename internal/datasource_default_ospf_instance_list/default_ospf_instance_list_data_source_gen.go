...
package datasource_default_ospf_instance_list
...
func DefaultOspfInstanceListDataSourceSchema(ctx context.Context) schema.Schema {
...
type DefaultOspfInstanceListModel struct {
