...
package datasource_route_reflector_client_list
...
func RouteReflectorClientListDataSourceSchema(ctx context.Context) schema.Schema {
...
type RouteReflectorClientListModel struct {
