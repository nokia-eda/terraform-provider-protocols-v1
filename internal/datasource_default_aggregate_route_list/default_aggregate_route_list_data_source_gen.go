...
package datasource_default_aggregate_route_list
...
func DefaultAggregateRouteListDataSourceSchema(ctx context.Context) schema.Schema {
...
type DefaultAggregateRouteListModel struct {
