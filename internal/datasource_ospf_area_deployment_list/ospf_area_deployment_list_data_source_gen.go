...
package datasource_ospf_area_deployment_list
...
func OspfAreaDeploymentListDataSourceSchema(ctx context.Context) schema.Schema {
...
type OspfAreaDeploymentListModel struct {
