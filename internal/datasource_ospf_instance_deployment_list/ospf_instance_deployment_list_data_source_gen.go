...
package datasource_ospf_instance_deployment_list
...
func OspfInstanceDeploymentListDataSourceSchema(ctx context.Context) schema.Schema {
...
type OspfInstanceDeploymentListModel struct {
