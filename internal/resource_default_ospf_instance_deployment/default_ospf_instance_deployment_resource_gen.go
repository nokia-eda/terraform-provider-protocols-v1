...
package resource_default_ospf_instance_deployment
...
func DefaultOspfInstanceDeploymentResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^DefaultOSPFInstanceDeployment$"), ""),
				},
				Default: stringdefault.StaticString("DefaultOSPFInstanceDeployment"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the DefaultOSPFInstanceDeployment",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"default_ospf_instance": schema.StringAttribute{
						...
						MarkdownDescription: "Reference to a DefaultOSPFInstance.",
					},
					"default_router": schema.StringAttribute{
						Required:            true,
						Description:         "Reference to a default Router",
						MarkdownDescription: "Reference to a default Router",
					},
					"node": schema.StringAttribute{
						Required:            true,
						Description:         "Reference to a Node on which to push the DefaultOSPFInstance.",
						MarkdownDescription: "Reference to a Node on which to push the DefaultOSPFInstance.",
					},
				},
				CustomType: SpecType{
					ObjectType: types.ObjectType{
				...
				MarkdownDescription: "DefaultOSPFInstanceDeploymentSpec defines the desired state of DefaultOSPFInstanceDeployment",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "DefaultOSPFInstanceDeploymentStatus defines the observed state of DefaultOSPFInstanceDeployment",
			},
		},
	}
}

type DefaultOspfInstanceDeploymentModel struct {
