...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-protocols/internal/datasource_bgp_peer"
...
const read_ds_bgpPeer = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/bgppeers/{name}"

var (
	_ datasource.DataSource              = (*bgpPeerDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*bgpPeerDataSource)(nil)
)
...
func (d *bgpPeerDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_bgpPeer, map[string]string{
...
func (r *bgpPeerDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
