...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-protocols/internal/resource_ospf_interface"
	"github.com/nokia/eda/apps/terraform-provider-protocols/internal/tfutils"
)

const (
	create_rs_ospfInterface = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/ospfinterfaces"
	read_rs_ospfInterface   = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/ospfinterfaces/{name}"
	update_rs_ospfInterface = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/ospfinterfaces/{name}"
	delete_rs_ospfInterface = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/ospfinterfaces/{name}"
)

var (
	_ resource.Resource                = (*ospfInterfaceResource)(nil)
	_ resource.ResourceWithConfigure   = (*ospfInterfaceResource)(nil)
	_ resource.ResourceWithImportState = (*ospfInterfaceResource)(nil)
)
...
func (r *ospfInterfaceResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_ospf_interface.OspfInterfaceResourceSchema(ctx)
}

func (r *ospfInterfaceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_ospf_interface.OspfInterfaceModel
	...
	err = r.client.Create(ctx, create_rs_ospfInterface, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_ospfInterface, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_ospfInterface,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *ospfInterfaceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_ospfInterface, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *ospfInterfaceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_ospfInterface, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
