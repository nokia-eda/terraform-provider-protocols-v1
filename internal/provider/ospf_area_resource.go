...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-protocols/internal/resource_ospf_area"
	"github.com/nokia/eda/apps/terraform-provider-protocols/internal/tfutils"
)

const (
	create_rs_ospfArea = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/ospfareas"
	read_rs_ospfArea   = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/ospfareas/{name}"
	update_rs_ospfArea = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/ospfareas/{name}"
	delete_rs_ospfArea = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/ospfareas/{name}"
)

var (
	_ resource.Resource                = (*ospfAreaResource)(nil)
	_ resource.ResourceWithConfigure   = (*ospfAreaResource)(nil)
	_ resource.ResourceWithImportState = (*ospfAreaResource)(nil)
)
...
func (r *ospfAreaResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_ospfArea, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_ospfArea, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_ospfArea,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *ospfAreaResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_ospfArea, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *ospfAreaResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_ospfArea, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
