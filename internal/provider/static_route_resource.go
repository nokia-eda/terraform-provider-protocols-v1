...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-protocols/internal/resource_static_route"
	"github.com/nokia/eda/apps/terraform-provider-protocols/internal/tfutils"
)

const (
	create_rs_staticRoute = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/staticroutes"
	read_rs_staticRoute   = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/staticroutes/{name}"
	update_rs_staticRoute = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/staticroutes/{name}"
	delete_rs_staticRoute = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/staticroutes/{name}"
)

var (
	_ resource.Resource                = (*staticRouteResource)(nil)
	_ resource.ResourceWithConfigure   = (*staticRouteResource)(nil)
	_ resource.ResourceWithImportState = (*staticRouteResource)(nil)
)
...
func (r *staticRouteResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_staticRoute, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_staticRoute, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_staticRoute,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *staticRouteResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_staticRoute, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *staticRouteResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_staticRoute, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
