...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-protocols/internal/resource_bgp_peer"
	"github.com/nokia/eda/apps/terraform-provider-protocols/internal/tfutils"
)

const (
	create_rs_bgpPeer = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/bgppeers"
	read_rs_bgpPeer   = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/bgppeers/{name}"
	update_rs_bgpPeer = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/bgppeers/{name}"
	delete_rs_bgpPeer = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/bgppeers/{name}"
)

var (
	_ resource.Resource                = (*bgpPeerResource)(nil)
	_ resource.ResourceWithConfigure   = (*bgpPeerResource)(nil)
	_ resource.ResourceWithImportState = (*bgpPeerResource)(nil)
)
...
func (r *bgpPeerResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_bgpPeer, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_bgpPeer, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_bgpPeer,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *bgpPeerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_bgpPeer, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *bgpPeerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_bgpPeer, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
