...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-protocols/internal/resource_ospf_instance"
	"github.com/nokia/eda/apps/terraform-provider-protocols/internal/tfutils"
)

const (
	create_rs_ospfInstance = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/ospfinstances"
	read_rs_ospfInstance   = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/ospfinstances/{name}"
	update_rs_ospfInstance = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/ospfinstances/{name}"
	delete_rs_ospfInstance = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/ospfinstances/{name}"
)

var (
	_ resource.Resource                = (*ospfInstanceResource)(nil)
	_ resource.ResourceWithConfigure   = (*ospfInstanceResource)(nil)
	_ resource.ResourceWithImportState = (*ospfInstanceResource)(nil)
)

func NewOspfInstanceResource() resource.Resource {
	return &ospfInstanceResource{}
}
...
func (r *ospfInstanceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_ospfInstance, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_ospfInstance, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_ospfInstance,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *ospfInstanceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_ospfInstance, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *ospfInstanceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_ospfInstance, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
...
func (r *ospfInstanceResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
