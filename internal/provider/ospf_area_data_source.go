...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-protocols/internal/datasource_ospf_area"
...
const read_ds_ospfArea = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/ospfareas/{name}"

var (
	_ datasource.DataSource              = (*ospfAreaDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*ospfAreaDataSource)(nil)
)
...
func (d *ospfAreaDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_ospfArea, map[string]string{
...
func (r *ospfAreaDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
