...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-protocols/internal/eda/utils"
...
var _ provider.Provider = (*protocolsProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &protocolsProvider{version: ver}
	}
}
...
func (p *protocolsProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *protocolsProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *protocolsProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "protocols-v1"
	resp.Version = p.version
}

func (p *protocolsProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAggregateRouteDataSource,
		NewAggregateRouteListDataSource,
		NewAppGroupDataSource,
		NewBgpGroupDataSource,
		NewBgpGroupListDataSource,
		NewBgpPeerDataSource,
		NewBgpPeerListDataSource,
		NewCheckDefaultBgpPeersDataSource,
		NewCheckDefaultBgpPeersListDataSource,
		NewDefaultAggregateRouteDataSource,
		NewDefaultAggregateRouteListDataSource,
		NewDefaultBgpGroupDataSource,
		NewDefaultBgpGroupListDataSource,
		NewDefaultBgpPeerDataSource,
		NewDefaultBgpPeerListDataSource,
		NewDefaultOspfAreaDataSource,
		NewDefaultOspfAreaDeploymentDataSource,
		NewDefaultOspfAreaDeploymentListDataSource,
		NewDefaultOspfAreaListDataSource,
		NewDefaultOspfInstanceDataSource,
		NewDefaultOspfInstanceDeploymentDataSource,
		NewDefaultOspfInstanceDeploymentListDataSource,
		NewDefaultOspfInstanceListDataSource,
		NewDefaultOspfInterfaceDataSource,
		NewDefaultOspfInterfaceListDataSource,
		NewDefaultRouteReflectorDataSource,
		NewDefaultRouteReflectorClientDataSource,
		NewDefaultRouteReflectorClientListDataSource,
		NewDefaultRouteReflectorListDataSource,
		NewDefaultStaticRouteDataSource,
		NewDefaultStaticRouteListDataSource,
		NewOspfAreaDataSource,
		NewOspfAreaDeploymentDataSource,
		NewOspfAreaDeploymentListDataSource,
		NewOspfAreaListDataSource,
		NewOspfInstanceDataSource,
		NewOspfInstanceDeploymentDataSource,
		NewOspfInstanceDeploymentListDataSource,
		NewOspfInstanceListDataSource,
		NewOspfInterfaceDataSource,
		NewOspfInterfaceListDataSource,
		NewResourceListDataSource,
		NewRouteReflectorDataSource,
		NewRouteReflectorClientDataSource,
		NewRouteReflectorClientListDataSource,
		NewRouteReflectorListDataSource,
...
func (p *protocolsProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewAggregateRouteResource,
		NewBgpGroupResource,
		NewBgpPeerResource,
		NewCheckDefaultBgpPeersResource,
		NewDefaultAggregateRouteResource,
		NewDefaultBgpGroupResource,
		NewDefaultBgpPeerResource,
		NewDefaultOspfAreaResource,
		NewDefaultOspfAreaDeploymentResource,
		NewDefaultOspfInstanceResource,
		NewDefaultOspfInstanceDeploymentResource,
		NewDefaultOspfInterfaceResource,
		NewDefaultRouteReflectorResource,
		NewDefaultRouteReflectorClientResource,
		NewDefaultStaticRouteResource,
		NewOspfAreaResource,
		NewOspfAreaDeploymentResource,
		NewOspfInstanceResource,
		NewOspfInstanceDeploymentResource,
		NewOspfInterfaceResource,
		NewRouteReflectorResource,
		NewRouteReflectorClientResource,
