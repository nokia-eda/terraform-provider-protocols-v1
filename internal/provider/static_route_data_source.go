...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-protocols/internal/datasource_static_route"
...
const read_ds_staticRoute = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/staticroutes/{name}"

var (
	_ datasource.DataSource              = (*staticRouteDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*staticRouteDataSource)(nil)
)
...
func (d *staticRouteDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_staticRoute, map[string]string{
...
func (r *staticRouteDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
