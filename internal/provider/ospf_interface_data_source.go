...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-protocols/internal/datasource_ospf_interface"
...
const read_ds_ospfInterface = "/apps/protocols.eda.nokia.com/v1/namespaces/{namespace}/ospfinterfaces/{name}"

var (
	_ datasource.DataSource              = (*ospfInterfaceDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*ospfInterfaceDataSource)(nil)
)
...
func (d *ospfInterfaceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = datasource_ospf_interface.OspfInterfaceDataSourceSchema(ctx)
}

func (d *ospfInterfaceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data datasource_ospf_interface.OspfInterfaceModel
	...
	err = d.client.GetByQuery(ctx, read_ds_ospfInterface, map[string]string{
...
func (r *ospfInterfaceDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
