...
func OspfAreaResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^OSPFArea$"), ""),
				},
				Default: stringdefault.StaticString("OSPFArea"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the OSPFArea",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "OSPFAreaSpec defines the desired state of OSPFArea",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "OSPFAreaStatus defines the observed state of OSPFArea",
			},
		},
	}
}
