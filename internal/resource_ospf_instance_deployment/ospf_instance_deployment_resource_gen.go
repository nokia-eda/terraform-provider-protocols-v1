...
package resource_ospf_instance_deployment
...
func OspfInstanceDeploymentResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^OSPFInstanceDeployment$"), ""),
				},
				Default: stringdefault.StaticString("OSPFInstanceDeployment"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the OSPFInstanceDeployment",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"node": schema.StringAttribute{
						...
						MarkdownDescription: "Reference to a Node on which to push the OSPFInstance.",
					},
					"ospf_instance": schema.StringAttribute{
						Required:            true,
						Description:         "Reference to an OSPFInstance.",
						MarkdownDescription: "Reference to an OSPFInstance.",
					},
				...
				MarkdownDescription: "OSPFInstanceDeploymentSpec defines the desired state of OSPFInstanceDeployment",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "OSPFInstanceDeploymentStatus defines the observed state of OSPFInstanceDeployment",
			},
		},
	}
}

type OspfInstanceDeploymentModel struct {
