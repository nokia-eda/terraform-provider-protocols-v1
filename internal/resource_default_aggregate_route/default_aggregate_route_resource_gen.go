...
package resource_default_aggregate_route
...
func DefaultAggregateRouteResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^DefaultAggregateRoute$"), ""),
				},
				Default: stringdefault.StaticString("DefaultAggregateRoute"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the DefaultAggregateRoute",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "DefaultAggregateRouteStatus defines the observed state of DefaultAggregateRoute",
			},
		},
	}
}

type DefaultAggregateRouteModel struct {
