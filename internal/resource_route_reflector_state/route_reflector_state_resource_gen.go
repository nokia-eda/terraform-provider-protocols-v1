...
package resource_route_reflector_state
...
func RouteReflectorStateResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^RouteReflectorState$"), ""),
				},
				Default: stringdefault.StaticString("RouteReflectorState"),
			},
			...
			"name": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "name of the RouteReflectorState",
				MarkdownDescription: "name of the RouteReflectorState",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"default_route_reflector": schema.BoolAttribute{
						Optional:            true,
					...
					"route_reflector_bgppeers": schema.ListAttribute{
						...
						MarkdownDescription: "A list of BGPPeers configured on the route reflector to peer with clients",
					},
				},
				CustomType: SpecType{
					ObjectType: types.ObjectType{
				...
				MarkdownDescription: "RouteReflectorStateSpec defines the desired state of RouteReflectorState",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "RouteReflectorStateStatus defines the observed state of RouteReflectorState",
			},
		},
	}
}

type RouteReflectorStateModel struct {
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	defaultRouteReflectorAttribute, ok := attributes["default_route_reflector"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`default_route_reflector is missing from object`)

		return nil, diags
	}

	defaultRouteReflectorVal, ok := defaultRouteReflectorAttribute.(basetypes.BoolValue)
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	case attr.ValueStateKnown:
		...
		val, err = v.DefaultRouteReflector.ToTerraformValue(ctx)
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.DefaultRouteReflector.Equal(other.DefaultRouteReflector) {
		return false
	}
