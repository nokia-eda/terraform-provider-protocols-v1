...
package datasource_default_bgp_group_list
...
func DefaultBgpGroupListDataSourceSchema(ctx context.Context) schema.Schema {
...
type DefaultBgpGroupListModel struct {
