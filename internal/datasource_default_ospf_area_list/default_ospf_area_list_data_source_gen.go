...
package datasource_default_ospf_area_list
...
func DefaultOspfAreaListDataSourceSchema(ctx context.Context) schema.Schema {
...
type DefaultOspfAreaListModel struct {
