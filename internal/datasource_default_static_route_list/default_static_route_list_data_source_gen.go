...
package datasource_default_static_route_list
...
func DefaultStaticRouteListDataSourceSchema(ctx context.Context) schema.Schema {
...
type DefaultStaticRouteListModel struct {
