...
package datasource_check_default_bgp_peers_list
...
func CheckDefaultBgpPeersListDataSourceSchema(ctx context.Context) schema.Schema {
...
type CheckDefaultBgpPeersListModel struct {
