...
package resource_default_ospf_area_deployment
...
func DefaultOspfAreaDeploymentResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^DefaultOSPFAreaDeployment$"), ""),
				},
				Default: stringdefault.StaticString("DefaultOSPFAreaDeployment"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the DefaultOSPFAreaDeployment",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					...
					"node": schema.StringAttribute{
						...
						MarkdownDescription: "Reference to a Node on which to push the DefaultOSPFArea.",
					},
				},
				CustomType: SpecType{
					ObjectType: types.ObjectType{
				...
				MarkdownDescription: "DefaultOSPFAreaDeploymentSpec defines the desired state of DefaultOSPFAreaDeployment",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "DefaultOSPFAreaDeploymentStatus defines the observed state of DefaultOSPFAreaDeployment",
			},
		},
	}
}

type DefaultOspfAreaDeploymentModel struct {
