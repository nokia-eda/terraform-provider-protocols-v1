...
package datasource_default_route_reflector_list
...
func DefaultRouteReflectorListDataSourceSchema(ctx context.Context) schema.Schema {
...
type DefaultRouteReflectorListModel struct {
