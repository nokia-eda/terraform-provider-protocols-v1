...
package resource_default_ospf_area
...
func DefaultOspfAreaResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^DefaultOSPFArea$"), ""),
				},
				Default: stringdefault.StaticString("DefaultOSPFArea"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the DefaultOSPFArea",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					...
					"num_active_interfaces": schema.Int64Attribute{
						...
						MarkdownDescription: "The number of active interfaces in the OSPF area.",
					},
					"num_neighbors": schema.Int64Attribute{
						Optional:            true,
						Computed:            true,
						Description:         "The number of discovered neighbors in the OSPF area.",
						MarkdownDescription: "The number of discovered neighbors in the OSPF area.",
					},
				},
				...
				MarkdownDescription: "DefaultOSPFAreaStatus defines the observed state of DefaultOSPFArea",
			},
		},
	}
}

type DefaultOspfAreaModel struct {
