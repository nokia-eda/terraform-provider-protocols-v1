...
package resource_ospf_area_deployment
...
func OspfAreaDeploymentResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^OSPFAreaDeployment$"), ""),
				},
				Default: stringdefault.StaticString("OSPFAreaDeployment"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the OSPFAreaDeployment",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"node": schema.StringAttribute{
						...
						MarkdownDescription: "Reference to a Node on which to push the OSPFArea.",
					},
					"ospf_area": schema.StringAttribute{
						Required:            true,
						Description:         "Reference to an OSPFArea.",
						MarkdownDescription: "Reference to an OSPFArea.",
					},
				...
				MarkdownDescription: "OSPFAreaDeploymentSpec defines the desired state of OSPFAreaDeployment",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "OSPFAreaDeploymentStatus defines the observed state of OSPFAreaDeployment",
			},
		},
	}
}

type OspfAreaDeploymentModel struct {
