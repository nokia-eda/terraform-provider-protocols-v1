---
page_title: "protocols-v1 Provider"
---

# protocols-v1 Provider

This provider is used to interact with the resources provided by the **protocols-v1** application of the [Nokia EDA](https://docs.eda.dev) platform.
