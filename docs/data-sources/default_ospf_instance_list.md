...
page_title: "protocols-v1_default_ospf_instance_list Data Source - protocols-v1"
subcategory: ""
description: |-
  
---

# protocols-v1_default_ospf_instance_list (Data Source)
...
- `lsa_timers` (Attributes) (see [below for nested schema](#nestedatt--items--spec--timers--lsa_timers))
- `spf_timers` (Attributes) (see [below for nested schema](#nestedatt--items--spec--timers--spf_timers))
