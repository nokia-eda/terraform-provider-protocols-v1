...
page_title: "protocols-v1_bgp_peer_list Data Source - protocols-v1"
subcategory: ""
description: |-
  
---

# protocols-v1_bgp_peer_list (Data Source)
...
- `status` (Attributes) BGPPeerStatus defines the observed state of BGPPeer (see [below for nested schema](#nestedatt--items--status))
