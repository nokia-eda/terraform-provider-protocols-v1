...
page_title: "protocols-v1_default_ospf_instance Data Source - protocols-v1"
subcategory: ""
description: |-
  
---

# protocols-v1_default_ospf_instance (Data Source)
...
- `name` (String) name of the DefaultOSPFInstance
...
- `lsa_timers` (Attributes) (see [below for nested schema](#nestedatt--spec--timers--lsa_timers))
- `spf_timers` (Attributes) (see [below for nested schema](#nestedatt--spec--timers--spf_timers))
