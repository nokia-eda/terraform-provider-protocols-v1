...
page_title: "protocols-v1_route_reflector_list Data Source - protocols-v1"
subcategory: ""
description: |-
  
---

# protocols-v1_route_reflector_list (Data Source)
...
- `spec` (Attributes) RouteReflector enables the configuration of iBGP sessions with RouteReflectorClients. It includes settings for selecting Interfaces, client selectors for IPv4 and IPv6, and the option to specify a BGP group and cluster ID. (see [below for nested schema](#nestedatt--items--spec))
...
- `status` (Attributes) RouteReflectorStatus defines the observed state of RouteReflector (see [below for nested schema](#nestedatt--items--status))
